...
<html lang="en">
    <head>
        ...
        <title>IIIT NAGPUR | Add Result</title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare IIIT NAGPUR Student Result</h2>
                        ...
                        <div class="row text-center center-it " style="margin-top: 105px;">
                                    <div class="col-md-6">
                                        <div class="panel">
                                           
                                            <div class="panel-body row h-100 row align-items-center" style="padding: 35px;">
<?php if($msg){?>
