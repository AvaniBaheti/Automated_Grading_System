...
<html lang="en">
    <head>
        ...
        <title>IIITN | Edit Student < </title>
                   ...
                   <?php include('includes/leftbar.php');?>  
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                        ...
                        <div class="row" >
                                    <div class="col-md-12" style="background-color:#d9e6f7">
                                        <div class="panel" style="background-color:#d9e6f7">
                                            <div class="panel-heading" style="background-color:#d9e6f7">
                                                <div class="panel-title">
                                                    <h5>Fill the Student info</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body" style="background-color:#d9e6f7">
<?php if($msg){?>
